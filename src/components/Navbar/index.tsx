...
function Navbar() {
    ...
    const fetchSearch = async () => {
        try {
            const response = await api.get(`/3/search/movie?query=${search}&include_adult=false&language=en-US&page=1`)
            ...
            <div className="flex justify-between items-center lg:w-[80%] md:w-[90%] w-[95%]  mx-auto">
                ...
                <div className="relative">
...

                    {
                        ...
                        <div className="absolute z-30 top-1 right-5 text-yellow-500 sm:text-2xl text-xl"
